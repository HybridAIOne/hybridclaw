...
|---|---------|-------------|----------|--------|
| 21 | **Business-skill pipeline + production skills** | R21.1 framework + 5 launch skills (Salesforce, HubSpot, SAP ERP, GA4, NL→SQL warehouse) + R21.7 Hetzner DevOps + R21.8 SAP Analytics Cloud + R21.9 DATEV + R21.10 Lexware Office + **R21.11 invoice harvester [#688](https://github.com/HybridAIOne/hybridclaw/issues/688)** + **DACH compliance bundle: R21.12 ELSTER [#689](https://github.com/HybridAIOne/hybridclaw/issues/689) · R21.13 XRechnung/ZUGFeRD/Peppol [#690](https://github.com/HybridAIOne/hybridclaw/issues/690) (P0 — 2025 mandate) · R21.14 HBCI/FinTS [#691](https://github.com/HybridAIOne/hybridclaw/issues/691) · R21.15 Handelsregister/Bundesanzeiger [#692](https://github.com/HybridAIOne/hybridclaw/issues/692) · R21.16 Schufa/Creditreform [#693](https://github.com/HybridAIOne/hybridclaw/issues/693)**. **Each skill ships as a NexAU-style component bundle** (system prompt + `tools.yaml` + `tools/*.py` + middleware + long-term memory) **so F12 + R10a auto-evolution can target it in place** without re-plumbing — see [paper §3.1](https://arxiv.org/html/2604.25850v1). *Principle I — the skills are the product.* | P0 | 🟡 2/16 (R21.1 ✅, R21.2 ✅; R21.6 🔄 #584) |
