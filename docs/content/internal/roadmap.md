...
|---|---------|-------------|----------|--------|
| 21 | **Business skills and connectors** | Production skills and connector work. See **R21 Production Skills** below for sub-issue rows. *Principle I — the skills are the product.* | P0 | 🟡 5/63 |
...
| R21.52 | Skill | Stock / equities deep-research skill (announcements, market explorer, financial deep research). DACH-relevant companion to the R21.28–R21.31 finance bundle. | ⬜ To be filed |
| R21.53 | Skill | Financial-services modeling bundle — 3-statement modeling, DCF, LBO, merger, comps, with Excel and PPTX authoring. Bridges R21.28 finance close and R21.41 pitch decks. | ⬜ To be filed |
| R21.54 | Skill | B2B lead-generation skill with ICP scoring. Workflow-shaped complement to the Salesforce / HubSpot connectors (R21.2 / R21.3). | ⬜ To be filed |
| R21.55 | Skill | OSINT / competitive-intelligence skill with sentiment monitoring + change detection. Operational sibling to R21.33 market-research analytics. | ⬜ To be filed |
| R21.56 | Skill | Forecasting / decision-support skill with Brier-scored superforecasting. No prior roadmap analogue. | ⬜ To be filed |
| R21.57 | Skill | RSS / HTTP / GitHub watcher skill — no-agent cron-mode polling. Background-curation companion to R41 skill-maintenance loop. | ⬜ To be filed |
| R21.58 | Skill | Shopify skill (Admin + Storefront GraphQL). Closes a noticeable gap given DACH e-commerce ambitions. | ⬜ To be filed |
| R21.59 | Skill | Airtable skill (records / views / automations). | ⬜ To be filed |
| R21.60 | Skill | Searxng-search skill — privacy-respecting metasearch across configurable engines. | ⬜ To be filed |
| R21.61 | Skill | Hyperframes / website-to-video creative pipeline. Fills the gap between R21.43 social-first ideation and R21.44 photo/video planning. | ⬜ To be filed |
| R21.62 | Skill | Serial / IoT hardware skill targeting RISC-V / ARM microcontrollers. Possible R32 sibling for embedded ops. | ⬜ To be filed |
| R21.63 | Tool | Native `video_analyze` tool via multimodal LLM — sibling to `image_analyze`. Tool primitive, not a skill. | ⬜ To be filed |
...
Use these as issue titles. Keep each issue small enough to ship independently. Prior-art notes from [paperclip.ing](https://paperclip.ing) annotated where relevant — the *primitives* transfer even though HybridClaw doesn't adopt the company / employee metaphor wholesale.
