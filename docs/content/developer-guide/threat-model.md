...
| Webhook and channel secrets | Discord, Slack, Telegram, email, voice, webhook signing keys | Validate destination and caller identity before use. Redact from setup output and persisted channel configuration. |
