...
- `/admin/channels` edits Discord, Slack, Telegram, Signal, WhatsApp, email,
  Microsoft Teams, iMessage, and voice (Twilio or Vonage) settings from one
  place
...
- `/admin/channels` saves `DISCORD_TOKEN`, `SLACK_BOT_TOKEN`,
  ...
  the CLI, plus `TWILIO_AUTH_TOKEN`, `VONAGE_PRIVATE_KEY`, and
  `VONAGE_SIGNATURE_SECRET` for the voice channel
