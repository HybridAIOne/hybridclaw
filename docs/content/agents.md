...
Canonical raw markdown start page:
- [`/content/agents.md`](/content/agents.md)

Main docs landing pages:
...
- [Skills](./extensibility/skills.md)
...
- [Web Search Tool](./reference/tools/web-search.md)
