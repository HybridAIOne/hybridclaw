...
- `SENTRY_DSN`, `SENTRY_ENVIRONMENT`, `SENTRY_RELEASE`, and `SENTRY_TRACES_SAMPLE_RATE` for optional Sentry gateway error reporting; see [Runtime Internals](../developer-guide/runtime.md)
