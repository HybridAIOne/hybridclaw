...
Use the full guide in [Channels: iMessage](../channels/imessage.md) for local macOS
...
Use the full guide in [Channels: Microsoft Teams](../channels/msteams.md) for the Azure app,
