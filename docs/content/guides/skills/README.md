...
HybridClaw ships **79 bundled skills**. The pages below cover the main
...
| Productivity | feature-planning, human-distill, project-manager, miro, trello | [Productivity Skills](./productivity.md) |
...
| Integrations & Utilities | 1password, stripe, mailchimp, download-platform-invoices, airtable, fastbill, hubspot, lexware-office, firecrawl, ga4, google-ads, heygen, sokosumi, gog, google-workspace, microsoft-365, zoho, current-time, hybridclaw-help, iss-position, search.web, search.news, search.images | [Integrations & Utilities](./integrations.md) |
