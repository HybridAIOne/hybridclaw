...
import {
  ...
  BROWSER_USE_MAX_COST_PER_TASK_USD,
  BROWSER_USE_MAX_SESSION_TIMEOUT_MINUTES,
  BROWSER_USE_PREFER_AGENT_MODE,
  CONTAINER_BINDS,
  CONTAINER_CPUS,
  CONTAINER_IMAGE,
  CONTAINER_MEMORY,
...
function getOrSpawnContainer(
  ...
  const args = [
    ...
    '-e',
    `BROWSER_CLOUD_PROVIDER=${BROWSER_CLOUD_PROVIDER}`,
    '-e',
    `BROWSER_USE_BASE_URL=${BROWSER_USE_BASE_URL}`,
    '-e',
    `BROWSER_USE_DEFAULT_MODEL=${BROWSER_USE_DEFAULT_MODEL}`,
    '-e',
    `BROWSER_USE_DEFAULT_PROXY_COUNTRY=${BROWSER_USE_DEFAULT_PROXY_COUNTRY}`,
    '-e',
    `BROWSER_USE_ENABLE_RECORDING=${BROWSER_USE_ENABLE_RECORDING ? 'true' : 'false'}`,
    '-e',
    `BROWSER_USE_MAX_COST_PER_TASK_USD=${BROWSER_USE_MAX_COST_PER_TASK_USD}`,
    '-e',
    `BROWSER_USE_MAX_SESSION_TIMEOUT_MINUTES=${BROWSER_USE_MAX_SESSION_TIMEOUT_MINUTES}`,
    '-e',
    `BROWSER_USE_PREFER_AGENT_MODE=${BROWSER_USE_PREFER_AGENT_MODE ? 'true' : 'false'}`,
    '-e',
    `BROWSER_USE_DETERMINISTIC_RERUN=${BROWSER_USE_DETERMINISTIC_RERUN ? 'true' : 'false'}`,
  ];
