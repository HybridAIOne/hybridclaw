...
import {
  ...
  type F7TrustedA2AJsonRpcPeer,
  getF7TrustedA2AJsonRpcPeerByPublicKeyPem,
  getF7TrustedA2AJsonRpcPeerBySender,
...
function peerInstanceId(peer: F7TrustedA2AJsonRpcPeer): string {
...
function resolveTrustedPeerForToken(params: {
  ...
  const peer = getF7TrustedA2AJsonRpcPeerBySender(
...
function resolveTrustedPeerForMtlsPublicKey(
  ...
  return getF7TrustedA2AJsonRpcPeerByPublicKeyPem(mtlsPublicKeyPem);
}
...
function resolveAuthenticatedPeer(params: {
  ...
  now?: Date;
  onPeerResolved?: (peer: F7TrustedA2AJsonRpcPeer) => void;
...
export function acceptA2AHttpEnvelopeInboundRequest(params: {
  ...
  let peer: F7TrustedA2AJsonRpcPeer | null = null;
